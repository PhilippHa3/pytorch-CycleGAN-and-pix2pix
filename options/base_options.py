...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='NAS', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        ...
        parser.add_argument('--layer_types', type=str, default='CycleGan', help='select layer types [CycleGan|PixelDa|CycleGan+ReLU|PixelDa+ReLU|all_layers|CycleGan+ReLU+Conv|CycleGan+ReLU+Pool]')
