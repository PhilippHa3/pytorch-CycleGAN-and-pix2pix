...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--layer_types', type=str, default='CycleGan', help='select layer types [CycleGan|PixelDa|CycleGan+ReLU|PixelDa+ReLU|all_layers|CycleGan+ReLU+Conv]')
