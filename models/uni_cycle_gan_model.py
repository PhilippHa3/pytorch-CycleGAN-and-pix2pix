...
class UniCycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netG_A = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, opt.netG, opt.norm,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, opt.n_layers_cell, opt.layer_types, opt.skip_connection, opt.n_blocks)
    ...
    def return_cell_weights(self):
        cell_netG_A, cell_netG_B = None, None
