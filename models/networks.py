...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[], n_layers_cell=5, layer_types='CycleGan', skip_connection=False, n_blocks=6):
    """Create a generator
    ...
    if netG == 'resnet_9blocks':
        ...
        net = NASGenerator(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=n_blocks, n_layers_cell=n_layers_cell, layer_types=layer_types, skip_connection=skip_connection)
    else:
...
class NASGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=3, padding_type='reflect', n_layers_cell=5, layer_types='CycleGan', skip_connection=False):
        ...
        elif layer_types == 'PixelDa+ReLU':
            self.layer_types = ['Conv2d+ReLU', 'BatchNorm2d']
        elif layer_types == 'all_layers':
        ...
        elif layer_types == 'ReflectionPad2d_Conv2d+ReLU':
            self.layer_types = ['ReflectionPad2d_Conv2d+ReLU']
